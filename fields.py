"""
fields.py — quantities that vary along the body, as curves rather than scalars.

The body coordinate s runs 0 (front of the head) → 1 (tip of the tail shield).
Landmarks on s: s_h = rear of the head, s_t = rear of the thorax (front of the tail).
"""
import numpy as np
